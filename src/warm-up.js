...
var vegetables = ["Green Pepper", "Carrot", "Onion", "Snap Pea", "Radish"];
...
var fruits = ["Apple", "Orange", "Banana", "Grapes", "Strawberries", "Mango", "Pineapple"];
...
var groceryStore = {
  ...
  isOpen: true,
  location: "Longmont",
  phoneNumber: 3038898429,
  managerName: "John Soopers",
  departments: ["deli", "meat", "seafood", "bakery", "customer service", "dairy/produce", "pharmacy"],
}
